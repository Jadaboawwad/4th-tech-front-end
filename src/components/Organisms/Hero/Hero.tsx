  ...
  return (
    ...
    <Container className={styles.gridWrapper}>
      ...
      <Container ref={leftRef1} className={`${styles.leftBlock1} ${leftInView1 ? styles.slideInLeft : ''}`}>
        <Paragraph className={styles.pargraph}>We offer comprehensive research development and specialized training services in cutting-edge technology, aimed at fostering innovation and enhancing technical skills..</Paragraph>
